...
def MoveArmInterface():
	...
	if request.params.get('command') in arm_interface_map:
		...
		return template('roboarm_rover_template', app_mode=app_mode, compiled_command=compiled_command)
		...
		return template('roboarm_rover_template', app_mode="initialising", compiled_command="")
